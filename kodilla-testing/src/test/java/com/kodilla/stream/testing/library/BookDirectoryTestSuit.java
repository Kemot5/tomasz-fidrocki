...
@ExtendWith(MockitoExtension.class)
    ...
    void testListLibraryUserNotTakeABook() {
        ...
        //When
        List<Book> resultListForZeroBooks = bookLibrary.listBooksInHandsOf(libraryUser2);
        //Then
    ...
    @Test
    void testListBooksInHandsOneBooks() {
        //Given
        LibraryUser libraryUser1 = new LibraryUser("mr tom", "kowalski", "500102");
        LibraryUser libraryUser2 = new LibraryUser(" mr mat", "nowak", "807898");
        List<Book> listBookInHandsOfOneBooks = generateListOfNBooks(1);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        when(libraryDatabaseMock.listBookInHandOf(libraryUser1)).thenReturn(listBookInHandsOfOneBooks);


        //When
        List<Book> resultListForOneBooks = bookLibrary.listBooksInHandsOf(libraryUser1);
        //Then
